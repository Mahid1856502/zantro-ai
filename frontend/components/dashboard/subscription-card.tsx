      ...
      <div className="grid gap-4">
        <CardHeader className="flex-row justify-between pb-4">
          ...
          <div className="flex">
            ...
            >
              {subscription.pricing_tier === "monthly" && <>Hacker</>}
              {subscription.pricing_tier === "yearly" && <>Professional</>}
            </Badge>
          </div>
        </CardHeader>
        <CardContent>
          {usage && (
            <div className="mb-4">
                  ...
                  {loading ? (
                    ...
                    <strong>
                      {usage?.percent_credit_used != null
                        ...
                        : "Cannot find remaining percentage. Please contact Swiftor support."}
                    </strong>
                  )}
                </p>
              </div>
              ...
              <p className="text-sm text-muted-foreground">
                {loading
                  ? "-"
                  : `${Math.min(usage?.percent_credit_used ?? 0, 100)}% of SwiftAI Credits used`}
              </p>
            </div>
          )}
          <div className="mb-4">
