...
import SwiftorLogo from "./ui/Swiftor.svg";
import {
  NavigationMenu,
          ...
          <div className="px-4">
            <div className="flex h-12 items-center justify-between">
              <div className="flex items-center">
                ...
                >
                  <SwiftorLogo />
                  <div className="h4 ml-2 font-black">swiftor</div>
                </Link>
                      ...
                      <DropdownNavItem trigger="Resources">
                        <ul className="grid w-[400px] gap-3 bg-background p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px]">
                          <ListItem href="/about" title="About">
                            Learn more about Swiftor
                          </ListItem>
                          <ListItem href="/blog" title="Blog">
                            Read insights on Swiftor&apos;s development by our
                            contributors
                          </ListItem>
                          <ListItem href="/faq" title="FAQ">
                            Frequently asked questions about Swiftor
                          </ListItem>
                          <ListItem href="/changelog" title="Changelog">
                            See what&apos;s new in Swiftor
                          </ListItem>
                        </ul>
                      </DropdownNavItem>
                      <NavItem href="/pricing">Pricing</NavItem>
                      <NavItem href="https://docs.swiftor.io" target="_blank">
                        Documentation
                      </NavItem>
                      <NavItem href="https://status.swiftor.io" target="_blank">
                        Status ⭐️
                      </NavItem>
                    </NavigationMenuList>
                  </NavigationMenu>
