...
const defaultMetadata = {
  title: "Swiftor - The All-in-One AI‑Powered Hacking Dashboard.",
  description:
...
export const constructMetadata = ({
  ...
  return {
    metadataBase: new URL("https://swiftor.io/"),
    title: title ? `${title} - Swiftor` : defaultMetadata.title,
    description,
    keywords: [
      "hacking dashboard",
      "ai hacking",
